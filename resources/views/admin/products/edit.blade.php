                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label>Price </label>
                                    <input type="number" min="0" step="any"  name="regular_price" class="form-control @error('regular_price') is-invalid @enderror" placeholder="Price" value="{{$product->regular_price/100}}" @if(!auth()->user()->isProductManager()) disabled @endif>
                                    @error('regular_price')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" step="any" name="action_price" class="form-control @error('number') is-invalid @enderror" placeholder="Action price if any" value="{{$product->action_price/100}}" @if(!auth()->user()->isProductManager()) disabled @endif>
                                    @error('action_price')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                                <div class="form-group">
                                    ...
                                    <input type="number" name="stock" class="form-control @error('stock') is-invalid @enderror" placeholder="0" value="{{$product->stock}}" @if(!auth()->user()->isProductManager()) disabled @endif>
                                    @error('stock')
                                    <div class="text-danger">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="form-group">
                                    <label>Image</label>
                                    <input type="file" name="image" class="form-control mb-3 @error('image') is-invalid @enderror" placeholder="Product image" >
